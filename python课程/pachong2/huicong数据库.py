...
class Hui(object):
    def __init__(self):
        ...
        # 数据库连接
        self.conn = pymysql.connect(host='localhost', user='root', password="123456", database='lsg', port=3306)
        # 获取游标
        ...
        for item in cate_li:
            ...
            for i in cate2_li:
                ...
                for j in cate3_li:
                    ...
                    sql = f'INSERT INTO huicong(cate1, cate2,cate3,name,price,img) VALUES ({str(data["cate1"])},{data["cate2"]},{data["cate3"]},{data["name"]},{data["price"]},{data["img"]});'
